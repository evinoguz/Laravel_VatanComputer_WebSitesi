...
<head>
    ...
    <link
        href="{{asset('CMS/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet')}}">
    <!-- JQVMap -->
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="{{route('CMS.home')}}" class="site_title"><i class="fa fa-paw"></i>
                        <span>Laravel CMS</span></a>
                </div>
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> Kategori <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{route('CMS.menu.list')}}">Kategori List</a></li>
                                    <li><a>Kategori Add</a>
                                        <ul class="nav child_menu">
                                            <li class="sub_menu">
                                                <a href="{{route('CMS.menu.create')}}">Kategori</a>
                                                <a href="{{route('CMS.menu.createsub')}}">Sub_Kategori</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-desktop"></i> Product <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{route('CMS.urun.list')}}">Product List</a></li>
                                    <li><a href="{{route('CMS.urun.create')}}">Product Add</a></li>
                                </ul>
                            </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <li><a href="{{route('log_out')}}"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
