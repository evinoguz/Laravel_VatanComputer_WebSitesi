            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="breadcrumb-tree">
                        ...
                        @foreach(\App\Models\Menus::where('id',$urunmores->menu_id)->get() as $roadmenu )
                            @foreach(\App\Models\SubMenus::where('id',$urunmores->submenu_id)->get() as $roadsubmenu)
                        <li>{{$roadmenu->name}}</li>
                        <li>{{$roadsubmenu->name}}</li>
                        @endforeach
                    @endforeach
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-md-push-2">
                    <div id="product-main-img">
                        ...
                        <div class="product-preview">
                            <img src="{{\App\Models\Products::find($urunmores-> id) -> img_url}}" alt="">
                        </div>
                    </div>
                </div>
                <!-- /Product main img -->
                ...
                <div class="col-md-2  col-md-pull-5">
                    <div id="product-imgs">
                        ...
                        @foreach(\App\Models\ProductImages::where('product_id',$urunmores->id)->get() as $uruncontent)
                        <div class="product-preview">
                            <img src="{{$uruncontent-> img_url}}" alt="">
                        </div>
                        @endforeach
                        <div class="product-preview">
                            <img src="{{\App\Models\Products::find($urunmores-> id) -> img_url}}" alt="">
                ...
                <div class="col-md-5">
                    <div class="product-details">
                        <h2 class="product-name">{{(\App\Models\Menus::find($urunmores-> menu_id) -> name)}}</h2>
                        <div>
                        ...
                        <div>
                            <h3 class="product-price">$ {{number_format($urunmores->price,2,',','.')}}
                                <del class="product-old-price">$ {{number_format($urunmores->price,2,',','.')}} </del></h3>
                            <span class="product-available">In Stock</span>
                        </div>
                        <p>{{$urunmores->content}}</p>
                        ...
                        <div class="add-to-cart">
                            ...
                            <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>
                                <a href="{{route('Front.sepet_post',$urunmores->id)}}">add to cart</a> </button>
                        </div>
